...
const routes = [
    {
        ...
        children: [{
            ...
            {
                path: 'login',
                loadChildren: () => Promise.all(/*! import() | pages-login-login-module */[__webpack_require__.e("default~pages-google-map-google-map-module~pages-login-login-module"), __webpack_require__.e("common"), __webpack_require__.e("pages-login-login-module")]).then(__webpack_require__.bind(null, /*! ../pages/login/login.module */ "./src/app/pages/login/login.module.ts")).then(m => m.LoginPageModule)
            },
            {
                path: 'signup',
            ...
            {
                path: 'reasons',
                loadChildren: () => __webpack_require__.e(/*! import() | pages-reasons-reasons-module */ "pages-reasons-reasons-module").then(__webpack_require__.bind(null, /*! ../pages/reasons/reasons.module */ "./src/app/pages/reasons/reasons.module.ts")).then(m => m.ReasonsPageModule)
            },
            {
                path: 'signup',
                loadChildren: () => Promise.all(/*! import() | pages-signup-signup-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-signup-signup-module")]).then(__webpack_require__.bind(null, /*! ../pages/signup/signup.module */ "./src/app/pages/signup/signup.module.ts")).then(m => m.SignupPageModule)
...
/* harmony import */ var _index_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index-routing.module */ "./src/app/index/index-routing.module.ts");
...
IndexPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _index_routing_module__WEBPACK_IMPORTED_MODULE_6__["IndexPageRoutingModule"]
        ],
